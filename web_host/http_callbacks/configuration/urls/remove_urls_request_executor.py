...
from modules.core.rabbitmq.messages.configuration.urls.remove_url_request import RemoveUrlsRequest
...
class RemoveUrlsRequestExecutor(BaseExecutor):
    ...
    async def execute(self, request: Request) -> Awaitable[StreamResponse]:
        ...
        response = self.rpcPublisher.call(CONFIGURATION_QUEUE, RemoveUrlsRequest(categories))
