...
from modules.core.rabbitmq.messages.configuration.todoits_categories.remove_todoist_categories_request import \
    RemoveTodoistCategoriesRequest
...
class RemoveTodoistCategoriesRequestExecutor(BaseExecutor):
    ...
    async def execute(self, request: Request) -> Awaitable[StreamResponse]:
        ...
        response = self.rpcPublisher.call(CONFIGURATION_QUEUE, RemoveTodoistCategoriesRequest(categories))
