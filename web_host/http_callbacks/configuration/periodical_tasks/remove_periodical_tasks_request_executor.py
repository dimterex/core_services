...
from core.rabbitmq.messages.configuration.periodical_tasks.remove_periodical_tasks_request import \
    RemovePeriodicalTasksRequest
...
class RemovePeriodicalTasksRequestExecutor(BaseExecutor):
    ...
    async def execute(self, request: Request) -> Awaitable[StreamResponse]:
        ...
        response = self.rpcPublisher.call(CONFIGURATION_QUEUE, RemovePeriodicalTasksRequest(categories))
