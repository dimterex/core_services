...
from modules.core.rabbitmq.messages.identificators import LOGGER_MESSAGE_TYPE, LOGGER_MESSAGE_LEVEL, LOGGER_MESSAGE_TAG, \
    LOGGER_MESSAGE_APPLICATION, LOGGER_MESSAGE_DATETIME, LOGGER_MESSAGE_MESSAGE, MESSAGE_PAYLOAD, MESSAGE_TYPE
...
class Log_Message:
    ...
    def to_json(self):
        dict_object = {
            MESSAGE_TYPE: LOGGER_MESSAGE_TYPE,
            MESSAGE_PAYLOAD: {
